...
//1.Qualification: BANG CAP
class Qualification {
  String? degree;
  String? completionData;
  //contructor
  Qualification({this.degree, this.completionData});

  //fromJson: tu Server -> model
  factory Qualification.fromJson(Map<String, dynamic> json) => Qualification(
      degree: json["degree"], completionData: json["completionData"]);

  //toJson: tu Model -> Server
  Map<String, dynamic> toJson() => {
        "degree": degree,
