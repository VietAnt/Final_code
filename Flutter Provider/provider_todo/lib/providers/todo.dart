...
import 'package:provider_todo/services/api.dart';
import 'package:provider_todo/utils/exceptions.dart';
import 'package:provider_todo/utils/todo_response.dart';
...
class TodoProvider with ChangeNotifier {
  ...
  Future<bool> toggleTodo(Todo todo) async {
    ...
    try {
      await apiService!.toggleTodoStatus(todo.id ?? 0, statusModified);
    } on AuthException {
      // API returned a AuthException, so user is logged out.
      await authProvider!.logOut(true);
      return false;
