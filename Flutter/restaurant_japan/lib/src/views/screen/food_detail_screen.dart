...
import 'package:restaurant_japan/core/app_icon.dart';
...
import 'package:restaurant_japan/src/views/widget/scale_animation.dart';
...
class FoodDetailScreen extends StatelessWidget {
  ...
  //*PreferredSizeWidget: Widget kích thước ưa thích
    ...
    return Scaffold(
      ...
      floatingActionButton: GetBuilder(
        builder: (FoodController foodController) {
          return fab(() {
            foodController.isFavoriteFood(food);
          });
        },
      ),
